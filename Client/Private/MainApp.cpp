...
HRESULT CMainApp::Initialize()
{
	...
	if (FAILED(m_pEngine->ReadyDevice(g_hWnd, WINCX, WINCY, g_hInst)))
		return E_FAIL;
...
HRESULT CMainApp::ReadyPrototypeComponent()
{
	...
	if (FAILED(m_pEngine->AddPrototype(SCENE_STATIC, "Prototype_VIBuffer_RectUI", CVIBuffer_RectUI::Create(m_pDevice, m_pDeviceContext))))
		return E_FAIL;
	if (FAILED(m_pEngine->AddPrototype(SCENE_STATIC, "Prototype_VIBuffer_RectEffect", CVIBuffer_RectEffect::Create(m_pDevice, m_pDeviceContext))))
		return E_FAIL;
	if (FAILED(m_pEngine->AddPrototype(SCENE_STATIC, "Prototype_VIBuffer_Rect", CVIBuffer_Rect::Create(m_pDevice, m_pDeviceContext))))
		return E_FAIL;
	if (FAILED(m_pEngine->AddPrototype(SCENE_STATIC, "Prototype_VIBuffer_Trail", CVIBuffer_Trail::Create(m_pDevice, m_pDeviceContext))))
		return E_FAIL;
	...
	/*NPC Information*/
	if (FAILED(m_pEngine->AddPrototype(SCENE_STATIC, "Prototype_NPCInfo", CNPCInfo::Create(m_pDevice, m_pDeviceContext))))
		return E_FAIL;

	/*Collidier*/
	if (FAILED(m_pEngine->AddPrototype(SCENE_STATIC, "Prototype_OBBCollider", CBasicCollider::Create(m_pDevice, m_pDeviceContext, CBasicCollider::TYPE_OBB))))
		return E_FAIL;

	if (FAILED(m_pEngine->AddPrototype(SCENE_STATIC, "Prototype_AABBCollider", CBasicCollider::Create(m_pDevice, m_pDeviceContext, CBasicCollider::TYPE_AABB))))
		return E_FAIL;

	/*Stat*/
	if (FAILED(m_pEngine->AddPrototype(SCENE_STATIC, "Prototype_Stat", CStat::Create(m_pDevice, m_pDeviceContext))))
		return E_FAIL;

	/*SkyBox*/
	if (FAILED(m_pEngine->AddPrototype(SCENE_STATIC, "Prototype_SkyBox", CTexture::Create(m_pDevice, m_pDeviceContext, CTexture::TYPE_DDS, "../../Assets/Textures/Sky/Sky.dds"))))
		return E_FAIL;
	/*Shop*/
	if (FAILED(m_pEngine->AddPrototype(SCENE_STATIC, "Prototype_Shop", CShop::Create(m_pDevice, m_pDeviceContext))))
		return E_FAIL;
...
#pragma region instancingTest
	////////////////////////////////////////////////////////////////
///* Component_VIBuffer_RectInstance */
...
////RotationMatrix = XMMatrixRotationX(XMConvertToRadians(90.0f));
	...
	if (FAILED(m_pEngine->AddPrototype("Prototype_Sky", CSky::Create(m_pDevice, m_pDeviceContext))))
		return E_FAIL;



	if (FAILED(m_pEngine->AddPrototype(SCENE_STATIC, "Prototype_InstanceModel", CInstanceModel::Create(m_pDevice, m_pDeviceContext))))
		return E_FAIL;

	if (FAILED(m_pEngine->AddPrototype("Prototype_EmptyMapObject", CEmptyMapObject::Create(m_pDevice, m_pDeviceContext))))
		return E_FAIL;
	...
	if (FAILED(m_pEngine->AddPrototype(SCENE_STATIC, "Prototype_Navigation", CNavigation::Create_ForTool(m_pDevice, m_pDeviceContext))))
		return E_FAIL;
	...
	if (FAILED(m_pEngine->AddPrototype("Prototype_EmptyUI", CEmptyUI::Create(m_pDevice, m_pDeviceContext))))
		return E_FAIL;
	if (FAILED(m_pEngine->AddPrototype("Prototype_EmptyEffect", CEmptyEffect::Create(m_pDevice, m_pDeviceContext))))
		return E_FAIL;
