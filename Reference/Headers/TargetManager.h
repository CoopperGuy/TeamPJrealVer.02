...
public:
	...
	HRESULT Begin_RT(ID3D11DeviceContext* pDeviceContext, string pTargetTag);
	HRESULT Begin_ShadowRT(ID3D11DeviceContext* pDeviceContext, string pTargetTag);

	HRESULT Begin_MainRT(ID3D11DeviceContext* pDeviceContext);
	HRESULT Clear_MainRT(ID3D11DeviceContext* pDeviceContext);
