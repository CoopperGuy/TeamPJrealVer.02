...
public:
	...
	//CGameObject* DeserializeInstancModel(const string & filePath);

	//void SerializeNavi(YAML::Emitter& out, CGameObject* obj);
	//CGameObject* DeserializeNavi(YAML::Node& obj, _bool bSpawn = false, _uint curScene = 0);
