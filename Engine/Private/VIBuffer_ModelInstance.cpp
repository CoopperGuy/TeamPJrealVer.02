#include "EnginePCH.h"
#include "..\Public\VIBuffer_ModelInstance.h"
#include "Pipeline.h"

CVIBuffer_ModelInstance::CVIBuffer_ModelInstance(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	: CVIBuffer(pDevice, pDeviceContext)	
{

}

CVIBuffer_ModelInstance::CVIBuffer_ModelInstance(const CVIBuffer_ModelInstance & rhs)
	: CVIBuffer(rhs)
...
HRESULT CVIBuffer_ModelInstance::InitializePrototype(string pShaderFilePath, _uint iNumInstance)
{
...
HRESULT CVIBuffer_ModelInstance::Initialize(void * pArg)
{
...
HRESULT CVIBuffer_ModelInstance::Update(_double TimeDelta)
{
...
HRESULT CVIBuffer_ModelInstance::Render(_uint iPassIndex)
{
...
CVIBuffer_ModelInstance * CVIBuffer_ModelInstance::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext, string pShaderFilePath, _uint iNumInstance)
{
	CVIBuffer_ModelInstance*	pInstance = new CVIBuffer_ModelInstance(pDevice, pDeviceContext);
...
CComponent * CVIBuffer_ModelInstance::Clone(void * pArg)
{
	CVIBuffer_ModelInstance*	pInstance = new CVIBuffer_ModelInstance(*this);
...
void CVIBuffer_ModelInstance::Free()
{
	__super::Free();
