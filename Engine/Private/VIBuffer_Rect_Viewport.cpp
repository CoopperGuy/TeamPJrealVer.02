...
#pragma region VERTEXBUFFER
	...
	((VTXTEX*)m_pVertices)[0].vPosition = _float3(fX / (WINCX * 0.5f) - 1.f, fY / (WINCY * -0.5f) + 1.f, 0.f);
	((VTXTEX*)m_pVertices)[0].vTexUV = _float2(0.f, 0.f);
	
	((VTXTEX*)m_pVertices)[1].vPosition = _float3((fX + fWidth) / (WINCX * 0.5f) - 1.f, fY / (WINCY * -0.5f) + 1.f, 0.f);
	((VTXTEX*)m_pVertices)[1].vTexUV = _float2(1.f, 0.f);

	((VTXTEX*)m_pVertices)[2].vPosition = _float3((fX + fWidth) / (WINCX * 0.5f) - 1.f, (fY + fHeight) / (WINCY * -0.5f) + 1.f, 0.f);
	((VTXTEX*)m_pVertices)[2].vTexUV = _float2(1.f, 1.f);

	((VTXTEX*)m_pVertices)[3].vPosition = _float3(fX / (WINCX * 0.5f) - 1.f, (fY + fHeight) / (WINCY * -0.5f) + 1.f, 0.f);
