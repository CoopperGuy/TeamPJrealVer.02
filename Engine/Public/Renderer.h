...
{
public:
	enum RENDER { RENDER_PRIORITY, RENDER_NONALPHA, RENDER_INSTANCEMAP, RENDER_EXTRA, RENDER_ALPHA, RENDER_TRAIL, RENDER_UI, RENDER_TEXT, RENDER_END };
private:
...
private:
	_float	m_fBrightIntensity = 0.06f;
	_uint	m_iValue = 0;
